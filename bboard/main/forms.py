...
# форма правки данных пользователя(комбинируем быстрое и полное объявление)
...
# форма занесения сведений о новом пльзователе (комбинируем быстрое и полное объявление)
...
# форма для работы с подрубриками
...
# форма правки и удаления объявлений
